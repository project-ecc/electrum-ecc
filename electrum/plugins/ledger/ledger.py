...
try:
    ...
    BTCHIP = True
    BTCHIP_DEBUG = False
    from .eccoinOverwrites import eccoinTransaction, btchip_eccoin
except ImportError:
    BTCHIP = False

MSG_NEEDS_FW_UPDATE_GENERIC = _('Firmware version too old. Please update at') + \
                      ' https://www.ledgerwallet.com'
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "ECCoin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        try:
            ...
            for utxo in inputs:
                ...
                if segwitTransaction and not client_electrum.supports_segwit_trustedInputs():
                    ...
                    txtmp = eccoinTransaction(bfh(utxo[0]))
